...
const T = {
  es: {
    ...
    cert_locked_body:      'Completa el 100% de los laboratorios para desbloquear tu certificado de finalización gratuito.',
  ...
  en: {
    ...
    cert_locked_body:      'Complete 100% of the labs to unlock your free certificate of completion.',
